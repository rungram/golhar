...
{ 
    ...
    $d->reset();
    $sql_tungdanhmuc="select * from #_product where hienthi =1 and id_list='$id' and ( hienngonngu =3 or hienngonngu =1) order by stt asc ";
...
else 
{
    $id =	addslashes($_GET['id']);
    $d->reset();
    $sql_tungdanhmuc="select * from #_product where hienthi =1 and id_list='$id' and ( hienngonngu =3 or hienngonngu =2) order by stt asc ";
    $d->query($sql_tungdanhmuc);
    $result_spnam=$d->result_array();
...
<section id="content">
	...
	<div class="col-lg-12">
		...
		<div class="col-lg-9">
			<div class="news">
			<h2 ><?php echo $result_laylist["ten_en"]?></h2>
			<div class="col-lg-12 listnews">
				<?php for($i=0,$count_tl=count($result_spnam);$i<$count_tl;$i++)
				{ 
				?>
