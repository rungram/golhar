...
<section id="content">
	...
	<div class="col-lg-12">
		...
		<div class="col-lg-9">
			...
			<h2>Giới thiệu</h2>
			<div class="caption">
				<p><?php echo $result_cat["noidung_vi"]?></p>
			</div>
			<div class="row">
				<div class="like-fb">
			...
			<div class="news">
				...
				<div class="row">
					...
					<div><i class="fa fa-fast-forward" aria-hidden="true"><a href="<?php echo $result_list["ten_en"]?>-cat/<?=$item["tenkhongdau"]?>-<?=$item["id"]?>.html">Chi tiết</a></i></div>
				</div>
				<?php
				} 
				?>
