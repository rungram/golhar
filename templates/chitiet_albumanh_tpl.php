<?php 
			$d->reset();
			$sql_tungdanhmuc="select * from #_thuvienanhcapcha where hienthi = 1  order by stt asc ";
			              ...
			              <div class="col-md-12 col-sm-12 ">
			                ...
			                <?php for($i=0,$count_spnam=count($result_hinhanh);$i<$count_spnam;$i++) { ?>
                              ...
                              <div class=" col-md-4 col-sm-4 col-xsm-6 col-xs-12  padding10">
			                    <div class="item-service"><a href="chi-tiet-anh/<?=$result_spnam[$i]['tenkhongdau']?>-<?=$result_hinhanh[$i]['id']?>.html" class="view-img"></a>
			                    <a target="_blank" href="chi-tiet-anh/<?=$result_spnam[$i]["thumb"]?>-<?=$result_spnam[$i]["id"]?>.html" class="view-img"><img src="upload/thuvienanhcapcha/<?php if($result_hinhanh[$i]["tc_big"]==1) echo $result_hinhanh[$i]["photo"]; else echo $result_hinhanh[$i]["photo"] ?>" alt=""></a></div>
		                      </div>
			                <?php }?>
		                    </div>
			                <div class="phantrang">
