...
//                         		  }
                                  ...
                                  ?>
                                  <div class="caption">
                                          <?php echo $result_gt[0]["mota_vi"]?>
                                  </div>
                                </div>
                                <div class="col-lg-5"><iframe class="video" width="100%" height="380px" src="https://www.youtube.com/embed/<?php echo $result_cat['url'] ?>" frameborder="1" allowfullscreen></iframe></div>
                    		</div>
