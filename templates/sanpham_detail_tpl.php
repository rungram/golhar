			     ...
			     <div class="col-lg-9">
                 		<div class="info_detail">
                              <h2>Chi tiết</h2>
                                  ...
                                  <div class="caption">
                                  			<img src="upload/sanpham/<?php if($chitiet_sp["tc_big"]==1) echo $chitiet_sp["photo"]; else echo $chitiet_sp["photo"] ?>" class="pull-left">
                                          <p><?=$chitiet_sp['mota_vi']?></p>
                                  </div>
                                  <div class="row">
                                    <div class="like-fb">
			              ...
			              <div class="col-md-12 col-sm-12 ">
                            ...
                            ?>
                              <div class=" col-md-3 col-sm-3 col-xsm-6 col-xs-12  padding10">
			                    <div class="item-relate"><a href="chi-tiet-san-pham/<?=$item["tenkhongdau"]?>-<?=$item["id"]?>.html" class="view-img"></a><a href="chi-tiet-san-pham/<?=$item["tenkhongdau"]?>-<?=$item["id"]?>.html" class="view-img"><img src="upload/sanpham/<?php if($item["tc_big"]==1) echo $item["photo"]; else echo $item["photo"] ?>" alt=""></a><a href="chi-tiet-san-pham/<?=$item["tenkhongdau"]?>-<?=$item["id"]?>.html">
		                        <h2><?=$item["ten_vi"]?></h2>
			                      </a> </div>
		                      </div>
		                      <?php
