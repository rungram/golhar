...
<form name="frm" method="post" action="index.php?com=tinloai2_1a&act=save&curPage=<?=$_REQUEST['curPage']?>" enctype="multipart/form-data" class="nhaplieu">
   
	
    <?php if ($_REQUEST['act']==edit)
	{?>
	<b>Hình hiện tại:</b><img src="<?=_upload_tinloai2_1.$item['thumb']?>"  width="120" alt="NO PHOTO" /><br />
	<?php }?>
...
<b>Nội dung tiếng anh</b><br/>
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=tinloai2_1a&act=man'" class="btn" />
</form>